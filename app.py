...
def plan_trip():
    ...
    prompt = (
        f"Create a detailed {days}-day student-friendly travel itinerary for {destination}."
        f"Include budget-friendly food, transport, and sightseeing recommendations."
